...
class MotionEpicMetaModel:
    def __init__(self, config):
        ...
        # add a customized block here to use VideoLLAVA.processor as multimodal_tower()
        # do we also want to include mm_input_projector?
        # for stage 1 training, we only train sg_encoder and mm_input_projector
    ...
    # Initialize multimodal modules, build_multimodal_tower, build_sg_encoder, build_input_projector
